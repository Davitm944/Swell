		...
		<div class='flex text-center justify-center mt-44'>
			<div class='text-center'>
				<div class='max-w-2xl mx-auto my-0'>
					<h1 class='text-8xl	text-primary font-roboto'>Sell creatiely</h1>
					...
					<div class='mt-10'>
						<input type='text' placeholder='Enter your email' class='border-2 border-solid border-purple-900 rounded py-3 px-2 h-10 w-64	' />
